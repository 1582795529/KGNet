...
class FeedbackHourGlass(nn.Module):
    def __init__(self, num_feature, num_vehicle_keypoint):
        super().__init__()
        self.num_feature = num_feature


        self.num_vehicle_keypoint = num_vehicle_keypoint
        ...
        self.hg_conv_out = nn.Sequential(
            ...
            nn.Conv2d(self.num_feature, self.num_vehicle_keypoint, 1))
        # self.out = nn.Conv2d(self.num_keypoints, self.num_vehicle_keypoint, 1)
