...
class BaseDataset(object):
    ...
    def print_dataset_statistics(self, train, query, gallery,query_gallary):
...
class BaseImageDataset(BaseDataset):
    ...
    def print_dataset_statistics(self, train, query, gallery,query_gallary):
        ...
        num_query_gallary_pids, um_query_gallary_imgs, num_quary_gallery_cams = self.get_imagedata_info( query_gallary)
        ...
        print("  query+gallery  | {:5d} | {:8d} | {:9d}".format(num_query_gallary_pids, um_query_gallary_imgs, num_quary_gallery_cams))
        print("  ------------------------------------------------")
